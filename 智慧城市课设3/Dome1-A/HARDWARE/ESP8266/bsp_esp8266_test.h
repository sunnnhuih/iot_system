...
#else
#define   macUser_ESP8266_BulitApSsid         "CSTX_ESP8266"      //要建立的热点的名称
#define   macUser_ESP8266_BulitApEcn           WPA_PSK               //要建立的热点的加密方式
#define   macUser_ESP8266_BulitApPwd           "88888888"         //要建立的热点的密钥
#endif


#define   macUser_ESP8266_TcpServer_IP         "192.168.4.2"      //服务器开启的IP地址
#define   macUser_ESP8266_TcpServer_Port       "5000"             //服务器开启的端口   
